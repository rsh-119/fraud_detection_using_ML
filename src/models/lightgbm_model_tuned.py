...
model_path = MODELS_DIR / "lightgbm_model_tuned.pkl"
joblib.dump(model_lgb, model_path)
print(f"✓ Model saved: {model_path}")

# Save feature importance
importance_df.to_csv(MODELS_DIR / "lightgbm_tuned_feature_importance.csv", index=False)
print(f"✓ Feature importance saved")

# Save metrics + threshold
with open(MODELS_DIR / "lightgbm_tuned_metrics.txt", "w") as f:
...
np.save(MODELS_DIR / "lightgbm_tuned_threshold.npy", best_threshold)
